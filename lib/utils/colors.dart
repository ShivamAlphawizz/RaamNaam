...
class AppColor {
  ...
  static const PrimaryDark = Color(0xff41b2ae);
  //Color(0xff451A35);
  Color colorPrimary() {
    return Color(0xff41b2ae);
      //Color(0xff451A35);
  }
...
extension colors on ColorScheme {
  ...
  static const Color primary = Color(0xff41b2ae);
  static const Color secondary = Color(0xff41b2ae);
