...
class _AddServicesState extends State<AddServices> {
  ...
  TextEditingController helperPricecontroller = TextEditingController();
  ...
  ///
   ...
   addServices()async{
    ...
    request.fields.addAll({
      ...
      'helper_price': helperPricecontroller.text,
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  type == "5" ?
                  "Price"
                  : "Price",style: TextStyle(fontSize: 14,fontWeight: FontWeight.w500),),
                SizedBox(height: 8,),
                ...
                SizedBox(height: 12,),
                /// Helper controller
             type == "5" ?   Text("Helper Price",style: TextStyle(fontSize: 14,fontWeight: FontWeight.w500),) : SizedBox.shrink(),
                type == "5" ?   SizedBox(height: 8,) : SizedBox.shrink(),
                type == "5" ?   TextFormField(controller: helperPricecontroller,decoration: InputDecoration(
                    hintText: "Helper Price",
                    fillColor: Colors.white,
                    filled: true,
                    border: OutlineInputBorder(
                      borderRadius: BorderRadius.circular(8),
                ...
                Center(
                    ...
                    InkWell(
                      onTap: ()async{
                        if(artistNameController.text.isEmpty || priceController.text.isEmpty ||sellingPriceController.text.isEmpty){
                          setState(() {
