...
import 'package:fixerking/screen/Pandit%20plans/myPlans.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future getVendorBooking() async {
    ...
    print("paramerts are here ${Apipath.getServiceBookingUrl} and ${request.fields}");
  ...
  Future getFoodOrders() async {
    ...
    http.StreamedResponse response = await request.send();
    print("response here now for the ${response.statusCode}");
    if (response.statusCode == 200) {
  ...
  getSharedData() async {
    ...
    print("shared prefs type ${type} and ${roles}");
    // if(onOfStatus == "1"){
    //   setState((){
    //     onOff = true;
    //   });
                          ...
                          Padding(
                            ...
                            child: roles == "Tent House" ? Text("New Order", style: TextStyle(
                              ...
                              fontWeight: FontWeight.w600,
                                ...
                                roles != "Grocery"  ? "Today Jobs" :  'New Order',
                                style: TextStyle(
                                  fontSize: 18,
                                  color: AppColor().colorPrimary(),
                                  fontWeight: FontWeight.w600,
