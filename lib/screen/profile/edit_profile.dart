...
class _EditNewProfileState extends State<EditNewProfile> {
  ...
  //       await http.MultipartFile.fromPath('adhar_card', aadharImage!.path.toString()));
   ...
   panImage == null ? null : request.files
    ...
    print("ok++++++++======>>>>${request.fields} and ${request.files}");
...
// You can request multiple permissions at once.
  ...
  void getCropImage(BuildContext context,int i,var image) async {
    ...
    print("checking i value here now ${i}");
    setState(() {
      if(i==1){
                        ...
                        child: Column(
                         crossAxisAlignment: CrossAxisAlignment.start,
                          ...
                          :  Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                type == "5"  || type == "7" || type == "8" ? SizedBox.shrink() : Padding(
                                  padding: const EdgeInsets.only(left:10),
                                  child: Text(
                                      type == "1" ?
                                      'Store Name'
                                ...
                                type == "5"   || type == "7" || type == "8" ? SizedBox.shrink() :     SizedBox(
                                  height: 10,
                                ),
                                type == "5"  || type == "7" || type == "8" ? SizedBox.shrink() :   Container(
                                  height: 50,
                                  child: TextFormField(
                                      keyboardType: TextInputType.name,
                                ...
                                type == "5"  || type == "7" ? SizedBox.shrink() :    const SizedBox(
                                  height: 10,
                                ),
                                type == "5"  || type == "7" ? SizedBox.shrink() :    Padding(
                                  padding: const EdgeInsets.only(left:10),
                                  child: Text('GST Number'),
                                ),
                                type == "7" ? SizedBox.shrink() :  SizedBox(
                                  height: 10,
                                ),
                                type == "7" ? SizedBox.shrink() :   Container(
                                  height: 50,
                                  child: TextFormField(
                                      keyboardType: TextInputType.name,
                         ...
                         type == "7" || type == "6" ? SizedBox.shrink() :   SizedBox(height: 10),
                            type == "7" || type == "6" ? SizedBox.shrink() :  Row(
                            ...
                            type == "7" || type == "6" ? SizedBox.shrink() :  isUpi == false
                                ? Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Padding(
                                ...
                                : SizedBox.shrink(),
                            type == "7" || type == "6" ? SizedBox.shrink() :   isUpi == true
                                ? Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                Padding(
